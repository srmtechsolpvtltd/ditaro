    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">{{$property->name}} Dashboard
                
                <div style="float:right;"><a href="{{ URL::to('/show-faq') }}/{{$property->id}}">View FAQ</a> | <a href="{{ URL::to('/faq-property') }}/{{$property->id}}">Add Faq </a> | <a href="{{ URL::to('/admin-upload') }}/{{$property->id}}">Upload File</a></div>
                
                </div>
                <form action="/adoption-change/{{$property->id}}" method="POST">

                    {!! csrf_field() !!}

                    <div class="panel-body">
                        <div class="stat-section">
                            <p><input name="start" propertyid="{{$property->id}}" class="date" style="margin-right:10px;" type="text" placeholder="Start Date" value="{{$property->start_date}}"><input name="end" propertyid="{{$property->id}}" class="date" value="{{$property->end_date}}" type="text" placeholder="End Date"></p><br>
                            ...
                            <tbody>
                                    ...
                                    @foreach($property->residents as $resident)
                                        <tr>
                                            ...
                                            <td><a data-toggle="tooltip" title="Delete" class="confirm" href="{{ URL::to('delete/resident') }}/{{$resident->id}}"><i style="color:red;margin-top:7px;" class="fa fa-times"></i></a></td>
                                        </tr>
